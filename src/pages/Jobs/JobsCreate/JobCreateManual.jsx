...
const JobCreateManual = () => {
  ...
  const CreateAiSuggestion = async (suggestionFor) => {
    try {
      ...
      if (suggestionFor === "description give first 100 words desc and then points in number format") {
            ...
            <>
              ...
              <div className="mb-4 border rounded p-2 shadow-md">
                  ...
                  <textarea
                   ...
                   < className={`form-textarea hover:shadow-xl p-2 mt-1 block w-full border border-gray-300 rounded-md ${
                    ...
                    className={`form-textarea p-2 mt-1 block w-full border border-gray-300 rounded-md ${
                      formSubmitted && JobData.description === ""
                ...
                <div className="mb-4">
                  <label className="block mb-2 font-bold text-gray-700">
                    ...
                    <div className="text-sm font-semibold text-gray-400 my-1">
                      Our AI generates job descriptions for you. You can make changes to better align with your hiring needs.
                    </div>
                  </label>
                  <textarea
                    rows={5}
                    ...
                    className={`form-textarea p-2 mt-1 block w-full border border-gray-300 rounded-md ${
                      formSubmitted && JobData.description === "" ? "border-red-500" : ""
                    }`}
                    placeholder="Selected intern's day-to-day description includes."
                  />
                </div>
              ...
              <div className="mb-4">
                ...
                <div className="flex flex-wrap gap-3">
                  {["10", "12", "diploma", "iti", "graduate", "postGraduate"].map((level) => (
                    <div
                      key={level}
                      className={`px-4 py-2 bg-white text-gray-900 border rounded-full cursor-pointer text-md hover:bg-blue-50 hover:text-blue-600 border-gray-300 ${
                        JobData?.minEducation === level ? "bg-blue-100 text-blue-600 border-blue-500" : ""
                      }`}
                      onClick={() => setJobData((prev) => ({ ...prev, minEducation: level }))}
                    >
                ...
                {JobData?.minEducation === "" && formSubmitted && (
                  <span className="text-sm font-medium text-red-600 block mt-2">
                    Please Select
                  </span>
                )}
                
                <label className="block text-lg font-semibold text-gray-900 my-4">
                  English Level Required
                  <span className="text-red-600 text-lg ml-1">*</span>
                </label>
                <div className="flex flex-wrap gap-3">
                  {["noEnglish", "basicEnglish", "goodEnglish"].map((level) => (
                    <div
                      key={level}
                      className={`px-4 py-2 bg-white text-gray-900 border rounded-full cursor-pointer text-md hover:bg-blue-50 hover:text-blue-600 border-gray-300 ${
                        JobData?.englishLevel === level ? "bg-blue-100 text-blue-600 border-blue-500" : ""
                      }`}
                      onClick={() => setJobData((prev) => ({ ...prev, englishLevel: level }))}
                    >
                      {level.replace(/([A-Z])/g, ' $1').trim()}
                    </div>
                  ))}
                ...
                <div className="flex flex-wrap gap-3">
                  {["any", "experiencedOnly", "fresherOnly"].map((exp) => (
                    <div
                      key={exp}
                      className={`px-4 py-2 bg-white text-gray-900 border rounded-full cursor-pointer text-md hover:bg-blue-50 hover:text-blue-600 border-gray-300 ${
                        JobData?.expRequired === exp ? "bg-blue-100 text-blue-600 border-blue-500" : ""
                      }`}
                      onClick={() => setJobData((prev) => ({ ...prev, expRequired: exp }))}
                    >
                      {exp.replace(/([A-Z])/g, ' $1').trim()}
                    </div>
                  ))}
                </div>
                ...
                {JobData?.expRequired !== "fresherOnly" && (
                  <>
                    ...
                    <div className="flex items-center gap-4 mt-2">
                      <div>
                        <select
                          className="w-36 px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                          name="minExp"
                          onChange={handleChange}
                  ...
                  <div className="flex flex-wrap gap-3 mb-4">
                    <div
                      className={`mr-2 mb-2 px-4 py-2 bg-white text-gray-900 border border-gray-300 rounded-full text-md cursor-pointer transition-colors hover:text-blue-600 hover:border-blue-600 ${
                        JobData?.salaryType === "fixed" ? "text-blue-600 border-blue-600" : ""
                      }`}
                      onClick={() => {
                    ...
                    <div
                      className={`mr-2 mb-2 px-4 py-2 bg-white text-gray-900 border border-gray-300 rounded-full text-md cursor-pointer transition-colors hover:text-blue-600 hover:border-blue-600 ${
                        JobData?.salaryType === "withIncentive" ? "text-blue-600 border-blue-600" : ""
                      }`}
                      onClick={() => {
                        setJobData((prev) => ({
                          ...prev,
                    ...
                    <div
                      className={`mr-2 mb-2 px-4 py-2 bg-white text-gray-900 border border-gray-300 rounded-full text-md cursor-pointer transition-colors hover:text-blue-600 hover:border-blue-600 ${
                        JobData?.salaryType === "onlyIncentive" ? "text-blue-600 border-blue-600" : ""
                      }`}
                      onClick={() => {
                        setJobData((prev) => ({
                          ...prev,
                    ...
                    <div className="flex items-center gap-4">
                      <div className="flex-1">
                        ...
                        <input
                          ...
                          className={`mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm ${
                            formSubmitted && JobData.minSalary === "" ? "border-red-500" : ""
                          }`}
                          disabled={JobData.salaryType === "onlyIncentive"}
                      ...
                      <div className="flex-1">
                        ...
                        <input
                          ...
                          type="number"
                          className={`mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm ${
                            formSubmitted && JobData.maxSalary === "" ? "border-red-500" : ""
                          }`}
                    ...
                    {JobData?.salaryType !== "fixed" && (
                      <div className="mb-4">
                        ...
                        <input
                          ...
                          type="number"
                          className={`mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm ${
                            formSubmitted && JobData?.incentive === "" ? "border-red-500" : ""
                          }`}
                      ...
                      <table className="table-auto border-collapse bg-blue-50 w-full rounded-md shadow-md">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td className="px-4 py-2 border-b">{JobData?.minSalary}-{JobData?.maxSalary}</td>
                          </tr>
                          <tr>
                            <td className="px-4 py-2 border-b">Incentives</td>
                            <td className="px-4 py-2 border-b">{JobData?.incentive}</td>
                          </tr>
                          <tr>
                            <td className="px-4 py-2 border-b text-right">Total</td>
                            <td className="px-4 py-2 border-b">
                              {parseInt(JobData?.minSalary) + parseInt(JobData?.incentive)} - {parseInt(JobData?.maxSalary) + parseInt(JobData?.incentive)}
                            </td>
                          </tr>
                        </tbody>
                      </table>
                                ...
                                <tr key={index}>
                                  <td className="px-2 py-4 text-gray-500">
                                    <select
                                      ...
                                      className="form-select p-2 px-3 m-1 w-1/2 border border-gray-300 rounded-md"
                                    >
                                    ...
                                    {skill?.type === "skill" && (
                                      <FormControl
                                        variant="outlined"
                                        className="form-select p-2 m-1 w-1/3"
                                      >
                    ...
                    {round.Assessment === "AI Based Video" && (
                          <div className="p-6 border border-gray-300 rounded-lg shadow-lg mb-6 bg-white">
                            <div className="flex flex-col md:flex-row gap-4">
                              ...
                              <FormControl className="w-full md:w-1/3">
                                <InputLabel id="topics-select-label">Select Topics</InputLabel>
                                <Select
                                  ...
                                  onChange={(event) => {
                                    ...
                                    setVideoInterview((prev) => ({
                                      ...prev,
                                      topic: Array.isArray(value) ? value : value.split(","),
                                    }));
                                    setJobData((prev) => ({
                                      ...prev,
                                      videoInterview: {
                                ...
                                >
                                  {options.map((option) => (
                                    <MenuItem key={option} value={option}>
                                      <Checkbox checked={videoInterview?.topic.includes(option)} />
                            ...
                            <button
                              ...
                              onClick={async () => {
                                ...
                                try {
                                  ...
                                  const formattedQuestions = Object.keys(responseData).map((key) => ({
                                    topic: key,
                        ...
                        {JobData.videoQuestions && (
                          <div className="mt-4">
                            ...
                            {JobData.videoQuestions && (
                              <div className="mt-6">
                                {JobData.videoQuestions.map((questionCategory) =>
                                  renderQuestions(questionCategory.topic, questionCategory.questions)
                                )}
                              </div>
                            )}
                          </div>
