          ...
          {JobData.type === "job" && (
            <>
              ...
              <JobDetails
                ...
                handlePositionNameInputChange={handlePositionNameInputChange}
                selectedSuggestionIndex={selectedSuggestionIndex}
                setPositionNames={setPositionNames}
                setSelectedSuggestionIndex={setSelectedSuggestionIndex}
                scrollToSelectedIndex={scrollToSelectedIndex}
                experienceOptionsYears={experienceOptionsYears}
                filteredMaxSalaryOptions={filteredMaxSalaryOptions}
                filteredMaxExpOptions={filteredMaxExpOptions}
                listRef={listRef}
                maxSalary={maxSalary}
                ...
                handleSkillInputKeyPress={handleSkillInputKeyPress}
